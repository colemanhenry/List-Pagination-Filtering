...
const maxStudentsOnPage = 10;
const totalLength = allStudents.length;
const studentList = document.getElementsByClassName('student-list');
const allStudents = document.querySelectorAll("student-item cf");
const studentDetails = document.getElementsByClassName('student-details');
let pageNumber = Math.ceil(students.length / studentsPerPage);
